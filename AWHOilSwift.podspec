#
#  Be sure to run `pod spec lint AWHOilSwift.podspec' to ensure this is a
#  确保运行“pod spec lint AWHOilSwift.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://gitee.com/WHWorkDevelopment/AWHOilSwift-iOS"
