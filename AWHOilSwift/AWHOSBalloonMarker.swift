//
//  AWHOSBalloonMarker.swift
//  AWHOilSwift
//
//  Created by 王恒 on 2025/7/28.
//
...
@objc open class AWHOSBalloonMarker: MarkerImage {
    ...
    @objc open var borderWidth = 1.0
    @objc open var type: Int
    @objc open var precision: Int
    ...
    @objc open func setLabel(_ newLabel: String)
    {
        ...
        style.lineSpacing = 8
        _drawAttributes[.paragraphStyle] = style
